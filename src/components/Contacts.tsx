...
const ContactMethod = ({ label, value, href, icon }: { label: string, value: string, href: string, icon: React.ReactNode }) => (
    <a
        href={href}
        target="_blank"
        rel="noopener noreferrer"
        className="group flex items-center justify-between p-4 rounded-2xl border border-gray-100 dark:border-zinc-800/50 hover:border-primary transition-all duration-300 bg-white dark:bg-zinc-900/50"
    >
        <div className="flex items-center gap-4">
            <div className="w-10 h-10 rounded-xl bg-gray-50 dark:bg-zinc-800 group-hover:bg-primary/10 flex items-center justify-center text-gray-400 group-hover:text-primary transition-colors">
                {icon}
            </div>
            <div>
        ...
        <div className="text-gray-300 dark:text-zinc-700 group-hover:text-primary transition-colors">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M7 7h10v10M7 17L17 7" /></svg>
        </div>
    </a>
);
    ...
    return (
        <section className="mt-2 mb-2 max-w-6xl mx-auto px-4">
            ...
            <div className="flex items-center justify-between mb-5 border-b border-gray-100 dark:border-zinc-900 pb-4">
                ...
                <div className="hidden md:flex items-center gap-2 px-3 py-1 bg-blue-600/5 border border-blue-600/10 rounded-full">
